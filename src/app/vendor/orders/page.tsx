...
export default function VendorOrders() {
  ...
  const fetchOrders = useCallback(async () => {
    setIsLoading(true);
    // No client-side session redirect here — middleware already guarantees
    // only an authenticated vendor reaches this page, and a second,
    // independently-timed check here could race with that and bounce an
