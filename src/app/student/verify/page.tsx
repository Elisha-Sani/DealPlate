...
export default function StudentVerify() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        sessionStorage.setItem(
            ...
            JSON.stringify({ university, regNumber }),
        );
    ...
    return (
        <motion.div
            ...
            className="max-w-105 w-full mx-auto py-4"
        >
            <StepIndicator
                currentStep={1}
                totalSteps={2}
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-[#5a4136] text-sm">
                    Exclusive deals are for verified students only. Tell us your
                    campus.
                </p>
            </div>
